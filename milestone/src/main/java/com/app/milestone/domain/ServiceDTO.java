...
//    @JsonFormat(pattern = "yyyy-MM-dd")
    ...
    @QueryProjection
    public ServiceDTO(String schoolName, String peopleNickname, Long userId, String schoolAddress, String schoolAddressDetail, LocalDateTime serviceVisitDate, Long donationId) {
